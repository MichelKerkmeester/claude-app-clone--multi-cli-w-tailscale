<script module lang="ts">
  import { applyingEffortMessage, effortStrings } from '../../effort.js';
...
<script lang="ts">
  ...
  import { focusVisible, focused, hover, press } from '../primitives/interactions.js';
  import Button from '../primitives/Button.svelte';
  import Sheet from '../primitives/Sheet.svelte';
  import SheetClose from '../primitives/SheetClose.svelte';
  import SheetContent from '../primitives/SheetContent.svelte';
  import SheetTitle from '../primitives/SheetTitle.svelte';
