...
<script lang="ts">
  import { buildTodoDisplayModel, TODO_STATE_LABELS } from '../../todo-model.js';
  import Button from '../primitives/Button.svelte';
  import Collapsible from '../primitives/Collapsible.svelte';
  import { focused, focusVisible, hover, press } from '../primitives/interactions.js';
