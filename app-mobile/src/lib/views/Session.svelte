<script module lang="ts">
  ...
  import type { SlashSubmitFailureCode } from '../../submitSlashDraft.js';
...
<script lang="ts">
  ...
  import { messageFrom, relativeTime, sessionStatusLabel } from './view-helpers.js';
  import { installCacheRevalidation } from '../../cache.js';
  import { abortPrompt, submitPrompt } from '../../relay.js';
  import { submitSlashDraft } from '../../submitSlashDraft.js';
  import { bindingMatchesSnapshot, type SelectedCommandBinding } from '../../commands.js';
  import { bindingAfterDraftChange } from '../../insertSlashCommand.js';
  import { modeAuthority } from '../../runtime.js';
  import { DEFAULT_MEDIA_CAPABILITY_OFF, EMPTY_TODO_PROJECTION_STATE } from '../../state.js';
  import { useRuntime } from '../useRuntime.svelte.js';
  import { useHostCommandCatalog } from '../hostCommandCatalog.svelte.js';
  import { useSyncSocket } from '../useSyncSocket.svelte.js';
