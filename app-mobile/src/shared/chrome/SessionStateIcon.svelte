...
<!-- @ds surface: session-state-icon — per-session status glyph. Decomposed from style.css; the
     ...
     the state-X wrapper — those grouped selectors stay GLOBAL in style.css (unchanged) so their
