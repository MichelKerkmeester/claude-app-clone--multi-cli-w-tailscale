...
import ArtifactDetails, { type ArtifactDetailsModel } from '../src/lib/artifacts/ArtifactDetails.svelte';
import ArtifactHeader from '../src/lib/artifacts/ArtifactHeader.svelte';
import PreviewControls from '../src/lib/artifacts/PreviewControls.svelte';
