<script lang="ts">
  // Renders the provider around a PreviewTrigger child that opens a
  // FilePreviewBlock through the real viewer context. Mirrors the React
...
<ArtifactViewerProvider>
  <ArtifactPreviewTriggerChild {block} />
</ArtifactViewerProvider>
