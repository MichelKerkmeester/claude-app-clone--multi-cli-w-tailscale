...
import type { ScopedCommandSnapshot, SelectedCommandBinding } from '../src/commands.js';
...
import { canonicalSlashMessage, submitSlashDraft } from '../src/submitSlashDraft.js';
