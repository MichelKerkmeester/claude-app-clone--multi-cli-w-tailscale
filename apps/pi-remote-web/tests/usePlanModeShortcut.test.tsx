// ───────────────────────────────────────────────────────────────────
// MODULE: Composer-Scoped Shortcut Tests
// ───────────────────────────────────────────────────────────────────
// Proves every Shift+Tab guard produces zero mode requests, bare Tab and
// outside-composer Shift+Tab keep browser focus navigation, ⌘⇧M opens the
// menu without changing mode, and the confirmed-mode routing (Build →
// request Plan, Plan → leave confirmation, executing → no-op announce).
...
import { usePlanModeShortcut, type PlanModeShortcutOptions } from '../src/usePlanModeShortcut.js';
...
function renderShortcut(
  ...
  function Harness() {
    ...
    const handle = usePlanModeShortcut({ ...options, composerRef });
    return (
      <>
        <textarea
          ref={composerRef}
