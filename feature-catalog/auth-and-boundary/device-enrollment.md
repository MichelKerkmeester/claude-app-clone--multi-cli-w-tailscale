...
| `apps/pi-remote-relay/tests/security/negative-controls.test.ts` | Integration | Uses a signed device enrollment as the fixture for the shared fail-closed controls |
