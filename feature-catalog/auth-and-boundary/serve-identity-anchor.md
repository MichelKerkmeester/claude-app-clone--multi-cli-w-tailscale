...
| `apps/pi-remote-relay/tests/security/negative-controls.test.ts` | Integration | Pins the read-only transport surface as a fail-closed control (no rich endpoint or host operation) |
