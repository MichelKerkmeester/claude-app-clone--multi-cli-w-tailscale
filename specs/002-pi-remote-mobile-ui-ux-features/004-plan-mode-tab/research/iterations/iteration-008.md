...
| `--action-bg` | carbon `#24221f` / bone `#f4f1eb` | Stop circle |
...
- Contrast pairs to add to `contrast.test.tsx`: `--ink` on `--canvas-subtle` (light `#24221f`/`#efeeeb`, dark `#f4f1eb`/`#1f1e1b`); `--control-border` on `--canvas-subtle` ≥ 3:1.
...
| Executing solid | `--ink` `#24221f` | `--ink` `#f4f1eb` |
| Chip fill | `--canvas-subtle` `#efeeeb` | `--canvas-subtle` `#1f1e1b` |
| Chip text | `--ink` `#24221f` | `--ink` `#f4f1eb` |
