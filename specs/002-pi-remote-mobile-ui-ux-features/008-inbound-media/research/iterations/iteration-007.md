...
Bone `#f8f8f6` / carbon ink `#24221f` / clay `#d97757`. Inter for chrome (15/20 card title, 12/16 meta); Source Serif 4 is **not** used on the card. Light + dark tokens. Contrast AA on withheld/error text without relying on clay alone.
