...
**Constraint:** ink-on-parchment (bone `#f8f8f6` / carbon ink `#24221f` / clay `#d97757`; Inter + Source Serif 4), light + dark, WCAG AA, React 19 + Vite + Tailwind 4 + react-aria-components. Mutations stay one-use ticketed + revision-checked and fail closed. Reuse F6 for the viewer.  
