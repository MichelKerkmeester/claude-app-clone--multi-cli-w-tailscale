...
Concrete direction for an ink-on-parchment ask-question card, grounded in the screens above and constrained by the fixed design system (bone `#f8f8f6` / carbon ink `#24221f` / clay `#d97757`; Inter + Source Serif 4; light + dark; WCAG AA) and read-only-by-default security posture.
