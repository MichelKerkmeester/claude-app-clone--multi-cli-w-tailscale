...
Concrete direction for pi's todos in Pi Remote's fixed ink-on-parchment system (bone `#f8f8f6` / carbon ink `#24221f` / clay `#d97757`; Inter + Source Serif 4; light + dark; WCAG AA) and read-only-by-default security posture, grounded in the screens above.
