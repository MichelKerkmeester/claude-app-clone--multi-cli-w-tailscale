...
- **Packet:** `app-mobile-cli/002-pi-remote-mobile-ui-ux-features`
...
- **Design system:** ink-on-parchment — bone `#f8f8f6` / carbon ink `#24221f` / clay `#d97757`; Inter + Source Serif 4; light + dark; WCAG AA. Not changed by this packet.
...
- [`build-strategy.md`](build-strategy.md) — autonomous build goal + external-model delegation (Claude orchestrates and verifies; DeepSeek v4 Flash / SOL high fast / Luna max fast implement — never Claude).
