...
| B2 | composer | SessionComposer(48) · ComposerCommandAutocomplete(54) | ✅ ported, verified 102/103, committed. 1 skip (mutual-exclusivity): jsdom can't run bits-ui focus-trap redirect / interact-outside dismiss; oracle passed it vacuously (floating content stays hidden in jsdom). Root-cause fix: `getClientRects` jsdom shim so floating-ui positions popover content. Real focus/dismiss → CDP gate. |
