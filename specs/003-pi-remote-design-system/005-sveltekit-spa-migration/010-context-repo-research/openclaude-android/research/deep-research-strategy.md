...
Mine the sibling app at `specs/context/openclaude-android-main` (READ-ONLY) for patterns adoptable by the Pi Remote SvelteKit mobile chat + remote-agent PWA, across ease-of-use, architecture, UX, and logic. Angles + where-to-look: read `specs/003-pi-remote-design-system/005-sveltekit-spa-migration/010-context-repo-research/openclaude-android/charter.md`. Produce adoptable-pattern findings with `specs/context/openclaude-android-main/file:line` citations. NEVER modify `specs/context/**`.
...
- Integration points: findings feed `specs/003-pi-remote-design-system/005-sveltekit-spa-migration/010-context-repo-research/openclaude-android/research/research.md`.
