...
_memory:
  continuity:
    packet_pointer: "specs/004-sk-code-mobile-cli-mode/002-scripts-ownership"
...
| Field | Value |
|---|---|
| Parent | `004-sk-code-mobile-cli-mode` |
| Level | 1 |
...
- `../spec.md` — the `004-sk-code-mobile-cli-mode` phase parent.
