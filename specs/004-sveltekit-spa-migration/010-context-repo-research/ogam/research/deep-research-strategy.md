...
Research charter: `specs/004-sveltekit-spa-migration/010-context-repo-research/ogam/charter.md` (target READ-ONLY; findings only).
...
- Consumer surface: Pi Remote SvelteKit mobile PWA (Svelte 5 runes migration track `004-sveltekit-spa-migration`).
