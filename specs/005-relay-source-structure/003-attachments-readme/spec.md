...
trigger_phrases:
  - "attachments readme spec requirements"
  - "attachments readme packet"
  - "spec requirements"
importance_tier: "normal"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "specs/005-relay-source-structure/003-attachments-readme"
...
- `../../004-sveltekit-spa-migration/014-folder-documentation/` — the folder-README convention.
