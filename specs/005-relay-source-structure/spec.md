...
trigger_phrases:
  - "relay source structure spec requirements"
  - "relay source structure packet"
  - "spec requirements"
importance_tier: "normal"
contextType: "planning"
_memory:
  continuity:
    packet_pointer: "specs/005-relay-source-structure"
...
> The folder is named `005-relay-source-structure` because the work began on app-relay; it has since
...
- `../004-sveltekit-spa-migration/020-source-structure/` — the web-client source-structure pass this
  mirrors on the relay.
- `../004-sveltekit-spa-migration/014-folder-documentation/` — the folder-README convention phase D
  follows.
