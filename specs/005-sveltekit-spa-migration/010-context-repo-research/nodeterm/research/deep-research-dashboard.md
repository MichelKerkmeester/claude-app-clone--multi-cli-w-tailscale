...
<!-- ANCHOR:status -->
## 2. STATUS
- Topic: Mine specs/context/nodeterm-main (READ-ONLY) for adoptable patterns for the Pi Remote SvelteKit mobile PWA; full angles in specs/005-sveltekit-spa-migration/010-context-repo-research/nodeterm/charter.md
