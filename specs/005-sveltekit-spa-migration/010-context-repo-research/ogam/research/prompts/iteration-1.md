...
Next focus: Iteration 1: Angle 1 [logic] — streaming-reply single-identity state machine (chatStore.ts, chatStoreReplyFinalization.ts, chatMessageMutationActions.ts, chatPersistence.ts).
...
Iteration: 1 of 10
Focus Area: Angle 1 [logic] — streaming-reply single-identity state machine: uuid-minted-at-startStreaming, NO_REPLY_FORMING single-source Pick<StreamingFields> type, ephemeral-end-BEFORE-durable-mutation ordering in finalizeStreamingMessage, resetStreamingSegment for multi-segment reasoning/answer, clearStreamingMessage vs finalize orphan handling. Files: src/stores/chatStore.ts, src/stores/chatStoreReplyFinalization.ts, src/stores/chatMessageMutationActions.ts, src/stores/chatPersistence.ts.
...
- Write iteration narrative to: specs/005-sveltekit-spa-migration/010-context-repo-research/ogam/research/iterations/iteration-001.md
- Write per-iteration delta file to: specs/005-sveltekit-spa-migration/010-context-repo-research/ogam/research/deltas/iter-001.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `specs/005-sveltekit-spa-migration/010-context-repo-research/ogam/research/iterations/iteration-001.md`, this iteration's narrative markdown
  ...
  - `specs/005-sveltekit-spa-migration/010-context-repo-research/ogam/research/deltas/iter-001.jsonl`, this iteration's delta JSONL
...
1. **Iteration narrative markdown** at `specs/005-sveltekit-spa-migration/010-context-repo-research/ogam/research/iterations/iteration-001.md` (path is pre-substituted for the current iteration number). Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.
