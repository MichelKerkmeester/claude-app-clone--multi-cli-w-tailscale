...
- [ ] **T3.1** Traceability: every requested field/RPC (T2.1–T2.13) cites a rec number in `../research/research.md` and names a consuming phase under `006-orca-nodeterm-ux-mining`. [will produce: a rec→field→consuming-phase trace table]
