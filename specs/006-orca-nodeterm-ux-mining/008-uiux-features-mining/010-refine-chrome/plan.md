---
title: "Phase 10 plan - Refine chrome"
description: "Sequenced approach for refine chrome: 50 screenshots, reviewed per shot, fixed in the component, proven by image diff."
trigger_phrases:
  - "refine chrome plan approach"
  - "refine chrome phase"
  - "plan approach"
...
_memory:
  continuity:
    ...
    recent_action: "Authored the refine chrome plan."
...
|-------|-----------|-----|
| 1 | `009-refine-artifacts` | The archive must be trustworthy before a shot is read as evidence |
...
| Phase | Effort | Note |
|-------|--------|------|
| 1 | M | 50 shots to read individually |
