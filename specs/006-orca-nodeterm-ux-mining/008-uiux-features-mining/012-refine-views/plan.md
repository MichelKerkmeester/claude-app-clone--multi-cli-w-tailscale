...
_memory:
  continuity:
    ...
    recent_action: "Authored the refine views plan."
...
|-------|-----------|-----|
| 1 | `011-refine-transcript` | The archive must be trustworthy before a shot is read as evidence |
...
| Phase | Effort | Note |
|-------|--------|------|
| 1 | M | 37 shots to read individually |
