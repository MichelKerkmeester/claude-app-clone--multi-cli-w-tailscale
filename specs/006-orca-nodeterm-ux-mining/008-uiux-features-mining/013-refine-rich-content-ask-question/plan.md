---
title: "Phase 13 plan - Refine rich-content + ask-question"
description: "Sequenced approach for refine rich-content + ask-question: 54 screenshots, reviewed per shot, fixed in the component, proven by image diff."
trigger_phrases:
  - "refine rich content ask question plan approach"
...
_memory:
  continuity:
    ...
    recent_action: "Authored the refine rich-content + ask-question plan."
...
# Phase 13 plan - Refine rich-content + ask-question
...
|-------|-----------|-----|
| 1 | `012-refine-views` | The archive must be trustworthy before a shot is read as evidence |
...
| Phase | Effort | Note |
|-------|--------|------|
| 1 | M | 54 shots to read individually |
