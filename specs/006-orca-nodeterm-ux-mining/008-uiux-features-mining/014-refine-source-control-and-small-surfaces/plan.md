...
_memory:
  continuity:
    ...
    recent_action: "Authored the refine source-control, attachments, primitives, home plan."
...
# Phase 14 plan - Refine source-control, attachments, primitives, home
...
|-------|-----------|-----|
| 1 | `013-refine-rich-content-ask-question` | The archive must be trustworthy before a shot is read as evidence |
...
| Phase | Effort | Note |
|-------|--------|------|
| 1 | M | 31 shots to read individually |
