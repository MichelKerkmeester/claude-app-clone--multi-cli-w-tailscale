...
const iters = [
  ...
  rec(20, {
    ...
    ruledOut: [{ approach: 'Further mining of orca PR sidebar/git history as session-selection sources', reason: 'Wrong object relative to ranked angles', evidence: 'specs/006-orca-nodeterm-ux-mining/research-angles.md:15:24' }],
    graphEvents: [
