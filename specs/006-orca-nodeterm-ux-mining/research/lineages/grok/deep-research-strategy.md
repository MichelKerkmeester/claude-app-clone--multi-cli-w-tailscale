...
Runtime strategy for `{artifact_dir}` = `specs/006-orca-nodeterm-ux-mining/research/lineages/grok`.
...
- Do not write outside `specs/006-orca-nodeterm-ux-mining/research/lineages/grok`.
