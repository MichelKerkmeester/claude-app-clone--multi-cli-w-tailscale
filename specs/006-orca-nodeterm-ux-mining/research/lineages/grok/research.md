...
Detached fan-out lineage. Write surface: `specs/006-orca-nodeterm-ux-mining/research/lineages/grok`.
...
Ours: `packages/pi-rpc-protocol/src/types.ts` (`SessionCardDto`, `AttentionItemDto`), `app-mobile/src/pages/home/screen-home.svelte`, `specs/006-orca-nodeterm-ux-mining/research-angles.md`.
