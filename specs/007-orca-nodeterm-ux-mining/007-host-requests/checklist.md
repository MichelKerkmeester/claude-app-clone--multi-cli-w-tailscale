...
- [ ] **CHK-SEC-02** [P0] Nothing under `specs/context/**` read or written; no file under `app-mobile/` created or edited. [evidence: `git status` — changes only under `specs/007-orca-nodeterm-ux-mining/007-host-requests/`]
<!-- /ANCHOR:security -->
...
- [ ] **CHK-ORG-01** [P1] The five Level-2 docs exist in the phase folder: `spec.md`, `plan.md`, `tasks.md`, `checklist.md`, `implementation-summary.md`. [evidence: `ls specs/007-orca-nodeterm-ux-mining/007-host-requests/`]
