...
`../research/research.md`; every row names a consuming phase under `007-orca-nodeterm-ux-mining`; no row proposes the
...
This phase creates only documentation under `specs/007-orca-nodeterm-ux-mining/007-host-requests/`; it edits no code and
runs no migration. `git checkout -- specs/007-orca-nodeterm-ux-mining/007-host-requests` removes the request docs. There
