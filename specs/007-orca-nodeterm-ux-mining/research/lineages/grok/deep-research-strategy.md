...
Runtime strategy for `{artifact_dir}` = `specs/007-orca-nodeterm-ux-mining/research/lineages/grok`.
...
- Do not write outside `specs/007-orca-nodeterm-ux-mining/research/lineages/grok`.
