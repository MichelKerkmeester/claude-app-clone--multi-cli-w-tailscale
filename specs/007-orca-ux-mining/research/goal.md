...
**Loop.** `opencode run --command deep/research` `:auto` `--spec-folder=specs/007-orca-ux-mining` `--max-iterations=20`, **no early convergence** (`--convergence-mode=off --stop-policy=max-iterations`), `NODE_PRESERVE_SYMLINKS=1` (symlink-containment fix). Findings → `specs/007-orca-ux-mining/research/`; full angles in `specs/007-orca-ux-mining/research-angles.md`.
