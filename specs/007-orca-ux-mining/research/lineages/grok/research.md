...
Detached fan-out lineage. Write surface: `specs/007-orca-ux-mining/research/lineages/grok`.
...
Ours: `packages/pi-rpc-protocol/src/types.ts` (`SessionCardDto`, `AttentionItemDto`), `app-mobile/src/pages/home/screen-home.svelte`, `specs/007-orca-ux-mining/research-angles.md`.
