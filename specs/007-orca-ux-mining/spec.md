---
title: "orca UX mining — implement the verified portable recommendations"
description: "Phase parent for implementing the ~48 verified, portability-checked recommendations from the orca deep-research run (research/research.md) into the SvelteKit mobile client. Grouped into phases by area and ordered by leverage and dependency: a tested pure-function foundation, home session-selection UX, chat message/transcript UX, composer UX, streaming and ask/permission hardening, navigation correctness, and a host-protocol request spec for the items that need new host fields. Every ported idea stays host-authoritative and fail-closed; nothing implements until the operator says go."
contextType: "planning"
_memory:
  continuity:
    packet_pointer: "specs/007-orca-ux-mining"
    last_updated_at: "2026-08-26T05:54:46.000Z"
    last_updated_by: "claude-opus-4-8"
    recent_action: "Research verified; phase parent scoped into seven implementation phases."
    next_safe_action: "Flesh each phase to Level 2+; do not implement until the operator says go."
    blockers: []
    completion_pct: 0
---
...
# orca UX mining — implementation phase parent

> **Phase links** — Research: [`research/research.md`](research/research.md) · Findings artifact published separately
...
|---|---|
| Mode | Phase parent |
| Source of truth | `research/research.md` (fresh-Opus-verified synthesis; ~48 recs, 0 hallucinations) |
